<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/appdb/nginx/html/MusicSpace/public/../application/index/view/index/index.html";i:1597478702;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>MPlayer音乐播放器</title>
	<link rel="stylesheet" href="/MusicSpace/public/static/css/mplayer.css">
	<style>
		.info {
...
<div class="mp">
	<div class="mp-box">
		<img src="/MusicSpace/public/static/img/mplayer_error.png" alt="music cover" class="mp-cover">
		<div class="mp-info">
...
<script src="/MusicSpace/public/static/js/jquery.js"></script>
<script src="/MusicSpace/public/static/js/mplayer.js"></script>
<script src="/MusicSpace/public/static/js/mplayer-list.js"></script>
<script src="/MusicSpace/public/static/js/mplayer-functions.js"></script>
...
var player = new MPlayer({
	...
	// 专辑图片错误时显示的图片
	defaultImg: "/MusicSpace/public/static/img/mplayer_error.png",
	// 自动播放
	autoPlay: true,
